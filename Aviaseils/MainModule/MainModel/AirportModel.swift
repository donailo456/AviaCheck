...
//  Aviaseils
//
//  Created by Danil Komarov on 28.09.2023.
//
...
//
//   let airportModel = try? JSONDecoder().decode(AirportModel.self, from: jsonData)

import Foundation

// MARK: - AirportModelElement
struct AirportModelElement: Codable {
    let id, type, code, name: String
    let countryCode, countryName: String
    let stateCode: JSONNull?
    let coordinates: Coordinates
    let indexStrings: [JSONAny]
    let weight: Int
    let cases, countryCases: JSONNull?
...
//    let id, type, code, name: String
//    let country_code, country_name: String
//    let state_code: String?
//    let coordinates: Coordinates
//    let weight: Int
//    let mainAirportName: String?
//    let city_code, city_name: String?
//}
//
//// MARK: - Coordinates
//struct Coordinates: Codable {
